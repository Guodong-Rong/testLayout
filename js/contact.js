/**
 * Validates user data before form submission.
 ...
 * @param {number} errorFound - The current error count.
 * @returns {number} Returns the updated error count.
 */
...
function validateMessage(errorFound) {
    ...
    if (document.getElementById("message").value === "") {
        // If no data, show an error message and increment error count
        document.getElementById("errorMessage").innerHTML = "The message cannot be empty";
        return ++errorFound;
    } else {
        // If data is entered, clear the error message and return the current error count
